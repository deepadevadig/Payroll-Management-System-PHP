                ...
                <input name="id" type="hidden" value="<?php echo $row['emp_id'];?>" />
                  ...
                  <div class="form-group">
                    ...
                    <select name="deduction" class="form-control" required>
                      ...
                      <option value="<?php echo $epf; ?>">EPF</option>
                      <option value="<?php echo $esi; ?>">ESI</option>
                      <option value="<?php echo $mutual_fund; ?>">Mutual Fund</option>
                      <option value="<?php echo $loans; ?>">Loans</option>
                      <option value="<?php echo $love; ?>">NIL</option>
                    </select>
                  </div>
                  </div>
                  <div class="form-group">
