...
$database="payroll";
  ...
  while($row=mysqli_fetch_array($query))
  {
    ...
    $total        = $epf + $esi + $mutual_fund + $loans + $love ;
  }
?>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        ...
        <p><a data-toggle="modal" class="btn btn-lg btn-success" href="#instructor" role="button">Brought To You By: MGV Creations </a></p>
      </div>
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
              <div align="center">
              <a href="" target="_blank" title="freeproject24"><big><b>MGV Creations</b></big></a>
              </div>
            </div>
          </div>
        </div>
